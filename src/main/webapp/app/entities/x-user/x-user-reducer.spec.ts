...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './x-user.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IXUser, defaultValue } from 'app/shared/model/x-user.model';
