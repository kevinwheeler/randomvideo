...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIDEOLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIDEOLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIDEOLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIDEOLIST actions', async () => {
      const expectedActions = [
        {
