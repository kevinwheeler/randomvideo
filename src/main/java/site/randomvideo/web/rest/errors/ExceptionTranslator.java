...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof site.randomvideo.service.EmailAlreadyUsedException ||
            ex instanceof site.randomvideo.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof site.randomvideo.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "site.randomvideo");
    }
}
